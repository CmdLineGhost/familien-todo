 // Familienmitglieder
        ...
        function renderTasks() {
            ...
            // Aufgaben filtern (nicht abgeschlossen, dem aktuellen Benutzer zugewiesen oder alle als Admin)
            const userTasks = tasks.filter(task =>
                !task.completed &&
                (task.assignedTo === currentUser.id || currentUser.isAdmin)
            ).slice(0, 5); // Nur die ersten 5 anzeigen
        ...
        function renderFullTodoList() {
            ...
            // Aufgaben filtern (dem aktuellen Benutzer zugewiesen oder alle als Admin)
            ...
            // Nach Erledigungsstatus und Fälligkeitsdatum sortieren
        ...
        function toggleTaskStatus(id) {
            ...
            if (taskIndex !== -1) {
                ...
                // Je nach aktiver Ansicht neu rendern
                ...
                // Feedback zeigen, wenn Aufgabe erledigt
        ...
        function saveTask() {
            ...
            // "me" in aktuellen Benutzer umwandeln
            if (assignedTo === 'me') {
